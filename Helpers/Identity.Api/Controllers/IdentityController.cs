...
namespace Identity.Api.Controllers
{
    ...
    {
        private const string TokenSecret = "ForTheLoveOfGodStoreAndLoadThisSecurely4S@f3ty0fUs4ll";
            ...
            [FromBody] TokenGenerationRequest request)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Issuer = "https://id.aspnetcorerestapi.com",
                Audience = "https://movies.aspnetcorerestapi.com",
